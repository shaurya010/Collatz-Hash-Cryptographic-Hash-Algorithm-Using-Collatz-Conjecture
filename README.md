...
## Test Collatz Hash: <a href="https://shaurya010.github.io/Collatz-Hash-Cryptographic-Hash-Algorithm-Using-Collatz-Conjecture/" target="_blank">Click</a> (Write now it's incomple so avoid to use. Use C++ files to run Collatz Hash)
